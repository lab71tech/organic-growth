...
- **Two-layer quality:** deterministic tools (build/lint/typecheck/test) after every stage, LLM deep review on demand, plus automatic post-stage review hook that injects the commit diff as review context
