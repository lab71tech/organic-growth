...
Read `docs/project-context.md` for product, tech stack, quality tools, and priorities.

<!-- Edit docs/project-context.md — it's the single source of truth for all AI tools. -->
